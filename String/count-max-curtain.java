...
The curtains are of two colors aqua(a) and black (b). The curtains color is 
represented as a string(str) consisting of a’s and b’s of length N. 
...
Note :If ‘L’ is not a multiple of N, the remaining number of curtains should be 
